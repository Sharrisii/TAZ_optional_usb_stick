...
f = urllib2.urlopen('http://www.quandl.com/api/v3/datasets/WORLDBANK/WLD_PHOSROCK?apikey=' + API_key_quandl + '&time=' + timestamp_today)
json_string = f.read()
...
f = urllib2.urlopen('https://rest.coinapi.io/v1/exchangerate/BTC/EUR?apikey=' + API_key_quandl + '&time=' + timestamp_yesterday)
json_string = f.read()
parsed_json = json.loads(json_string)
...
f = urllib2.urlopen('https://rest.coinapi.io/v1/exchangerate/LTC/EUR?apikey=' + API_key_quandl + '&time=' + timestamp_today)
json_string = f.read()
parsed_json = json.loads(json_string)
...
f = urllib2.urlopen('https://rest.coinapi.io/v1/exchangerate/LTC/EUR?apikey=' + API_key_quandl + '&time=' + timestamp_yesterday)
json_string = f.read()
parsed_json = json.loads(json_string)
