...
# date format example: 2018-02-23
from datetime import datetime, timedelta
clock = datetime.now()
date_today = str(str(clock.year) + ('-' if len(str(clock.month)) > 1 else '-0') + str(clock.month) + ('-' if len(str(clock.day)) > 1 else '-0') + str(clock.day))
clock = datetime.now() - timedelta(days=1)
date_yesterday = str(str(clock.year) + ('-' if len(str(clock.month)) > 1 else '-0') + str(clock.month) + ('-' if len(str(clock.day)) > 1 else '-0') + str(clock.day))
...
f = urllib2.urlopen('http://data.fixer.io/api/' + date_today + '?access_key:' + API_key_fixer + '&symbols=CNY&base=EUR')
json_string = f.read()
...
# temporarily under the name "currency_rate_today_cnyeur"
f = urllib2.urlopen('http://data.fixer.io/api/' + date_yesterday + '?access_key:' + API_key_fixer + '&symbols=CNY&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
...
f = urllib2.urlopen('http://data.fixer.io/api/' + date_today + '?access_key:' + API_key_fixer + '&symbols=INR&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
...
# temporarily under the name "currency_rate_today_inreur"
f = urllib2.urlopen('http://data.fixer.io/api/' + date_yesterday + '?access_key:' + API_key_fixer + '&symbols=INR&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
...
f = urllib2.urlopen('http://data.fixer.io/api/' + date_today + '?access_key:' + API_key_fixer + '&symbols=USD&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
...
# temporarily under the name "currency_rate_today_usdeur"
f = urllib2.urlopen('http://data.fixer.io/api/' + date_yesterday + '?access_key:' + API_key_fixer + '&symbols=USD&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
...
f = urllib2.urlopen('http://data.fixer.io/api/' + date_today + '?access_key:' + API_key_fixer + '&symbols=RUB&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
...
# temporarily under the name "currency_rate_today_rubeur"
f = urllib2.urlopen('http://data.fixer.io/api/' + date_yesterday + '?access_key:' + API_key_fixer + '&symbols=RUB&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
...
f = urllib2.urlopen('http://data.fixer.io/api/' + date_today + '?access_key:' + API_key_fixer + '&symbols=MXN&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
...
# temporarily under the name "currency_rate_today_mxneur"
f = urllib2.urlopen('http://data.fixer.io/api/' + date_yesterday + '?access_key:' + API_key_fixer + '&symbols=MXN&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
...
f = urllib2.urlopen('http://data.fixer.io/api/' + date_today + '?access_key:' + API_key_fixer + '&symbols=JPY&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
...
# temporarily under the name "currency_rate_today_jpyeur"
f = urllib2.urlopen('http://data.fixer.io/api/' + date_yesterday + '?access_key:' + API_key_fixer + '&symbols=JPY&base=EUR')
json_string = f.read()
parsed_json = json.loads(json_string)
