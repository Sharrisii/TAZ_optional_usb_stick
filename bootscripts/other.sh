...
# Example code: code to create the paths to /etc/init.d/net.eth* and /etc/init.d/net.wlan*, needed for temporary IPv6 and MAC addresses
...
# cd /mnt/*/networking/
# cp -f net /etc/conf.d/
# echo "0 */2 * * * rc-service net.eth* restart" >> "/var/spool/cron/crontabs/root"
...
# If you want to copy over any gajim plugins from https://dev.gajim.org/gajim/gajim-plugins/tree/master
# then place them in /plugins/gajim/
